...
解决上述缺点的根本方法是：
* 将全连接甚至一般的卷积都转化为***稀疏连接***

<font size="2">为了**打破网络对称性**和**提高学习能力**，传统的网络都使用了***随机稀疏连接***。但是，计算机软硬件对非均匀稀疏数据的计算效率很差，所以在AlexNet中又重新启用了全连接层，目的是为了更好地优化并行运算。</font>

<font size="2">***TODO:*** 现在的问题是有没有一种方法，既能保持网络结构的稀疏性，又能利用密集矩阵的高计算性能。</font>
...
<font size="2">***Inception 的作用***：代替人工确定卷积层中的过滤器类型或者确定是否需要创建卷积层和池化层。即：不需要人为的决定使用哪个过滤器，是否需要池化层等，由网络自行决定这些参数。</font>
