...
#### 20. 基础平台篇：回顾与总结
基础平台篇的主要内容 —— 抽象信息世界的骨架

##### 信息世界的骨架
<div align="center"><img src="pics/skeleton-of-information-world.png" width="45%"></div>

内容组织结构如下，
<div align="center"><img src="pics/content-structure.png" width="45%"></div>

该篇以架构为导向，抽象出系统的骨架，融会贯通，把这些领域知识串起来，拼出完整的版图。

###### 抽象有助于记忆，因为骨架需要逻辑的自洽。

##### 穿插内容： 抽象能力的重要性
它是融会贯通、疏通整个信息世界的知识脉络的关键。当你做到对世界的认知**可宏观、可微观**，自然一切皆在掌握。

##### 穿插内容： 架构之美在于悟
信息世界是无中生有创造出来的，我们需要的不是去记忆，而是要找到创造背后的骨架和逻辑。

日常生活中随处可见的架构之美，如果你只能从你自己写业务代码中感受架构之道，那么你可能就要多留些心思了。

###### 用思考的方式去记忆，而不是用记忆的方式去思考。 看到了，悟到了，就学到了。

##### 最后，作为架构师，如何构建需求分析能力，尤其是需求的预判能力？
* 首先，归纳总结能力很重要。 分析现象背后的原因。
* 另外，批判精神也同样至关重要。 关键是切实找到技术中存在的效率瓶颈和心智负担，同时善于找出现状与书的历史背景差异。
